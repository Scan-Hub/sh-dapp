...
import {
  selectSectorOfInvestment,
  selectStageOfInvestment,
...
const Description = ({
  ...
  const listSector = useSelector(selectSectorOfInvestment); //Sector of investment
  const listStage = useSelector(selectStageOfInvestment); //Stage of Investment
