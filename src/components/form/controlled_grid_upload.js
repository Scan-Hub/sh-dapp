...
import ControlledUploadImage from "./controlled_upload_image"
            ...
            <Controller
              ...
              render={({ field, formState: { errors } }) => (
                <ControlledUploadImage
                  title={<img src={company.IcWhitePlus} alt="ic_white_plus" />}
                  caption={""}
                  width={100}
                  height={100}
  ...
  const renderPagination = () => {
    return (
      <div className="flex flex-row gap-x-4">
        <div
          className={clsx("flex flex-row bg-box-bg p-2 pr-4 rounded-lg ", {
        ...
        >
          <img src={company.IcPlus} width="16" height="16" alt="ic_plus" />
        </div>
        <div
          className={clsx("flex flex-row bg-box-bg p-2 pl-4 rounded-lg", {
