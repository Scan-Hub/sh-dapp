...
export function InputArea({
  ...
  return (
    <div className={`${className} flex flex-col w-full`}>
      <div className={`${title ? "mb-3 " : "mb-0"} flex flex-row items-center`}>
        {title && (
          <>
            <p
      ...
      <div className="relative rounded-lg flex flex-row items-center bg-box-bg">
        <textarea
          ...
          className={`${
            iconLeft && "pl-12"
          } bg-box-bg focus:ring-1 focus:ring-vbDisableText focus:rounded-lg rounded-lg py-3 px-4 focus:outline-none appearance-none w-full font-montserrat placeholder:text-placeholder-text ${
            disable ? "text-disabled-text" : "text-white"
