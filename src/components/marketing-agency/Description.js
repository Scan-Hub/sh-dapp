...
const Description = ({
  ...
  const employeesNumbers = [
    { id: 1, name: "Less than 50" },
    { id: 2, name: "51 to 200" },
    { id: 3, name: "201 to 1000" },
    { id: 4, name: "1001 to 5000" },
    { id: 5, name: "More than 5000" },
  ];
        ...
        <div className="flex sm:flex-row items-start justify-between flex-col mt-4 w-full sm:space-x-12 sm:space-y-0 space-y-4">
          <div className="w-1/2">
            ...
            <div className="flex flex-col mt-6 space-y-6">
              ...
              <DatePickerComponent
                ...
                setValue={setValue}
                title={"Date"}
                name={"vcs_description_date"}
                placeholder={"Choose a date"}
                error={errors.vcs_description_date}
                control={control}
              />
              <div className="mt-6">
                ...
                <UploadFile
                  ...
                  setValue={setValue}
                  name={"vcs_description_certificate"}
                  error={errors.vcs_description_certificate}
                />
              </div>
            </div>
          </div>
          ...
          <div className="w-1/2">
            ...
            <SelectBox
              ...
              name={"vcs_description_number_of_employees"}
              placeholder={"Select"}
              error={errors.vcs_description_number_of_employees}
              control={control}
            />
            <SelectTags
              required
              className={"mt-6 space-y-3"}
              title={"Marketing Sector"}
              data={sectorData}
            ...
            <CheckBoxGroup
              ...
              data={otherCategorys}
              name="vcs_description_other_category"
              setValue={setValue}
              error={errors.vcs_description_other_category}
            />
          </div>
        </div>
